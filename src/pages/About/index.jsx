      ...
      <div className="flex flex-col gap-3 ">
        ...
        <section className="flex flex-col gap-4 py-4">
          ...
          <p className="text-justify lg:text-sm text-[13px] antialiased leading-relaxed tracking-wider">
            Graduated from Institut Teknologi Telkom Purwokerto with a major in
            S1 Software Engineering in 2020-2024. Has completed the college time
            in 3.5 years with a GPA of 3.93. Have an internship experience at PT
            Telkom Indonesia for 6 months with the Backend Developer position in
            charge of creating algorithms and providing REST API services and PT
            Sinergi Talenta Group for 3 months with the Frontend Developer
            position in charge of converting visual designs into html, css and
            javascript codes and making website displays interactive. <br /> I
            have a strong understanding of software development through the
            Software Development Lifecycle (SDLC) with the stages of planning,
            analysis, design, development, testing, and system maintenance, to
            achieve good software quality and meet user needs.
          </p>
        </section>
