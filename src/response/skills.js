...
const frameworkSkill = [{
    ...
    {
        icon: `${baseUrl}/src/assets/icons/fiber.svg`,
        title: "Fiber",
    },
    {
...
const toolsSkill = [{
    ...
    {
        icon: `${baseUrl}/src/assets/icons/rabbitmq.svg`,
        title: "RabbitMQ",
    },
    {
...
const dbmsSkill = [{
    ...
    {
        icon: `${baseUrl}/src/assets/icons/gorm.svg`,
        title: "Gorm",
    },
];

export { languageSkill, frameworkSkill, toolsSkill, dbmsSkill };